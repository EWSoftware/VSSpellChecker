...
internal static partial class AssemblyInfo
{
    ...
    public const string StrongNameVersion = "2014.6.14.0";
    ...
    public const string FileVersion = "14.6.14.0";
    ...
    public const string ProductVersion = "2014.6.14.0";

    // Assembly copyright information
    public const string Copyright = "Copyright \xA9 2013-2014, Eric Woodruff, All Rights Reserved.\r\n" +
        "Portions Copyright \xA9 2010-2014, Microsoft Corporation, All Rights Reserved.";
}
